  ...
  )
{
  ...
  switch (Type) {
    case SWM_PWD_TYPE_SET_PASSWORD:
    {
      ...
      mNewPassword->Base.GetControlBounds (
                           mNewPassword,
                           &ControlBounds
                           );
      ...
      //
      mNewPasswordConfirm = new_EditBox (
                              ControlOrigX,
                              ControlOrigY,
                              SWM_PWD_DIALOG_MAX_PWD_DISPLAY_CHARS,
                              UIT_EDITBOX_TYPE_PASSWORD,
      ...
      mNewPasswordConfirm->Base.GetControlBounds (
                                  mNewPasswordConfirm,
                                  &ControlBounds
                                  );
