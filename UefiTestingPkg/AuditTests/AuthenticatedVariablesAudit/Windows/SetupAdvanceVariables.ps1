...
# =======================================================================================
# Test Name: ContentInfo
# Test Description:
#   This test checks to see if authenticated variables supports ContentInfo (asn.1 structure)
#   and SignedData (Currently the only one supported)
#
...
$VariableData =  "Signed By SHA384 Certificate"
# Variable Prefix must be different
...
# =============================================================================
# Variable data *should* be different
$VariableData =  "Signed By SHA512 Certificate"
# Variable Prefix must be different
$VariablePrefix = "m${KeyLength}${TestGroup}"
...
$KeyLength = 4096
# Variable data *should* be different
$VariableData =  "Signed By ${KeyLength} certificate and intermediate certificate"
# Variable Prefix must be different
$VariablePrefix = "m1${TestGroup}"
