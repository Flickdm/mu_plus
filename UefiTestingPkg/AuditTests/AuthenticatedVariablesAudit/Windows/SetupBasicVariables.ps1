...
$ret = GenerateTestData $VariableName $VariablePrefix $VariableData @($2KMockVar.CertInfo) $null @() "SHA256"
if (!$ret) {
    Exit
}
...
$ret = GenerateTestData $VariableName $VariablePrefix $VariableData @($3KMockVar.CertInfo) $null @() "SHA384"
if (!$ret) {
    Exit
}
...
$ret = GenerateTestData $VariableName $VariablePrefix $VariableData @($4KMockVar.CertInfo) $null @() "SHA512"
if (!$ret) {
    Exit
}
...
$ret = GenerateTestData $VariableName $VariablePrefix $VariableData @($3KMockVar.CertInfo) $null `
     @($Intermediate2.CertPath, $Intermediate1.CertPath) "SHA384"
if (!$ret) {
    Exit
}
...
$ret = GenerateTestData $VariableName $VariablePrefix $VariableData @($4KMockVar.CertInfo) $null `
    @($Intermediate2.CertPath, $Intermediate1.CertPath, $Intermediate0.CertPath) "SHA512"
if (!$ret) {
    Exit
}
